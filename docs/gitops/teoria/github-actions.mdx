...
:::tip Extensión de VSCode

Para una experiencia de desarrollo fluida, instala la extensión oficial de GitHub Actions para VSCode. Te ofrece autocompletado, validación en tiempo real y navegación rápida entre workflows.

<InstallExtension id="github.vscode-github-actions" label="GitHub Actions" />
