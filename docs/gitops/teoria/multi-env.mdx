...
<K8sPlaygroundLink example="argocd">Haz el laboratorio completo (ArgoCD, dev/staging/prod, commit y push) en el playground</K8sPlaygroundLink>
...
<K8sPlaygroundLink example="kustomize">Prueba base y overlays en el playground (kubectl kustomize, kubectl apply -k)</K8sPlaygroundLink>
