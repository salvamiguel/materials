...
<K8sPlaygroundLink example="hola">Aplica este Deployment en el playground y borra un pod para ver cómo vuelve</K8sPlaygroundLink>
...
<K8sPlaygroundLink example="config">ConfigMap y Secret en el playground de Kubernetes</K8sPlaygroundLink>
...
<K8sPlaygroundLink>Practica estos comandos en el playground de Kubernetes (sin instalar nada)</K8sPlaygroundLink>
