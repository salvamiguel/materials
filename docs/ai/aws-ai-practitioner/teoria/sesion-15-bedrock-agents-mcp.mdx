...
# Bedrock Agents y MCP <FaAws style={{ verticalAlign: 'middle' }} />
...
<SkillBuilderLab
  tipo="lab"
  title="Lab Tutorial - Build AWS Lambda Powered MCP Tools for AI Agents (Beta)"
  url="https://skillbuilder.aws/learn/DMDVXK4UGQ/lab-tutorial--build-aws-lambda-powered-mcp-tools-for-ai-agents-beta/FTF9UKY2EG"
/>
...
<SkillBuilderLab
  tipo="examen"
  title="Official Pretest: AWS Certified AI Practitioner (AIF-C01)"
...
<SkillBuilderLab
  tipo="simulearn"
  title="AWS SimuLearn: Financial Insights with Multimodal Agents"
  url="https://skillbuilder.aws/search?searchText=Financial%20Insights%20with%20Multimodal%20Agents"
>
