...
:::tip Pruébalo con Terraform "de verdad"
En el [playground de Terraform](/terraform-playground) puedes escribir tu propia configuración y ejecutar `init`, `plan`, `apply` y `destroy` en el navegador, con el esquema real del proveedor AWS y sin credenciales.
:::
